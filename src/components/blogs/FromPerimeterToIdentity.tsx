...
// Uses the same layout + ToC rail pattern as your other posts
            ...
            <div className="post-container max-w-[1150px] mx-auto">
              ...
              >
                ...
                <section id="least-privilege" className="scroll-mt-28">
                  ...
                  <p className="mt-[10px]">These practices shrink your attack surface and contain damage when a breach occurs.</p>
                </section>
