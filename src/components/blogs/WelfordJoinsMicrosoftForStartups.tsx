...
// Matches the same grid/ToC rail pattern used in your other posts
import { useEffect, useMemo, useState } from "react";
import { Link } from "react-router-dom";
import { Calendar, User, ArrowLeft } from "lucide-react";
import Layout from "@/components/layout/layout";
import TableOfContent from "@/components/tableofcontent";
import postImage from "@/assets/msf1.png"; // update path if needed
    ...
    <Layout>
      ...
      <div className="relative w-full">
        ...
        >
            ...
            <div className="post-container max-w-[1150px] mx-auto">
              ...
              >
                ...
                <section id="step-plan" className="scroll-mt-28">
                  ...
                  <ol className="list-decimal pl-6 mt-[10px] space-y-[10px] marker:text-slate-600">
                    <li>
                ...
                <section id="for-customers" className="scroll-mt-28">
                  ...
                  <ul className="list-disc pl-6 mt-[10px] space-y-[10px] marker:text-slate-600">
                    <li>Faster roadmap execution and higher reliability through proven Azure patterns.</li>
                    <li>Stronger security posture, continuous verification, and audit-ready evidence.</li>
                    <li>Simpler procurement via marketplace and enterprise agreements.</li>
                  </ul>
                </section>
          ...
          {/* Right rail ToC — sticky, 10px away, never overlays */}
          <aside
            className="
              hidden xl:block
              sticky top-[10px]
            ...
            "
          >
            {/* Border-left is owned by the TableOfContent component */}
