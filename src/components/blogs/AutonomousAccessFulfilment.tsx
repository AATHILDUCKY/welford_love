...
import postImage from "@/assets/auto3.png"; // place image in your assets
import "@/styles/post.css";

const AutonomousAccessFulfilment = () => {
  const brand = "#032955";

  // Reading progress bar (clamped & resilient)
  ...
  return (
    <Layout>
      ...
      <div className="relative flex justify-center w-full">
        ...
        {/* Right rail ToC (OUTSIDE article, fixed on the right) */}
